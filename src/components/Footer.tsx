...
export default function Footer() {
  return (
    <footer className="bg-ink text-white mt-24">
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/60">
            <li className="flex items-center gap-2"><FiMapPin /> Karachi, Pakistan</li>
            <li className="flex items-center gap-2"><FiPhone /> +92 300 0000000</li>
            <li className="flex items-center gap-2"><FiMail /> hello@hnicecream.com</li>
          </ul>
        </div>
      </div>
